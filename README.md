...
1. [Lab-2](https://github.com/cerebralace/LMDSX/tree/master/Lab%202) - The second lab will guide participants in creating an R notebook and Shiny UI in DSX using RStudio.
